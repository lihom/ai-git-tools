...
echo "--------------------------------------------------"
echo "To configure your AI engine, set the following environment variables in your .env file:"
echo "  AI_ENGINE=gemini # options: gemini, ollama, codex, claude, cursor, copilot"
echo "  OLLAMA_MODEL=gemma4"
echo "  GEMINI_MODEL=gemini-3-flash-preview"
echo "  CODEX_MODEL=gpt-5.3-codex"
echo "  COPILOT_MODEL=claude-haiku-4.5"
